<?php
        ...
        if(move_uploaded_file($_FILES['myheader']['tmp_name'],$target_path))    //to upload header image
        {
                ...
                system("convert $target_path -resize x60  $target_path");   //resizes header image to 60px height
